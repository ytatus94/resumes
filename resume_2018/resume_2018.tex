...
\item Passionate about discovering insights lie hidden in data and able to tell the story of data to non-experts.
...
\item Improve true positive rate from 0.85 to 0.93 by developing a new classification model for the electron isolation efficiency and became the standard version of the collaboration.
...
Programmed in C++ to redesign a bug-free Monte Carlo simulation programs.
...
\item Coordinated effectively with cross-functional teams and clients to resolve issues by tight deadlines.
...
\location{}
\begin{tightemize}
\item Build a restaurant recommender system to recommend top 5 restaurants using item-item similarity based collaborative filtering and matrix factorization based on users’ past visits and ratings.
